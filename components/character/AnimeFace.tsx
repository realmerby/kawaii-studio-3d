...
export function AnimeFace({
  ...
  return (
    <group position={[0, 0, 0]}>
      {/* ============================================================ */}
      {/* 1. LARGE EXPRESSIVE ANIME EYES (On Head Surface Z=0.385)     */}
      {/* ============================================================ */}
      <group position={[0, 0.04, 0.38]}>
        ...
        >
          ...
          {/* Large Vibrant Anime Iris */}
          <group position={[0.005, -0.006, 0.002]}>
            {/* Base Iris */}
            <mesh>
            ...
            {eyeStyle === 'cateye' && (
              <>
                ...
                <mesh position={[-0.014, -0.024, 0.004]}>
          ...
          <group position={[0, 0.06, 0.005]} rotation={[0, 0, -0.04]}>
            <mesh>
            ...
            {/* Winged Tip */}
            <mesh
              position={[-0.07, eyeStyle === 'cateye' ? 0.022 : 0.014, 0]}
              rotation={[0, 0, eyeStyle === 'cateye' ? 0.75 : 0.5]}
            >
              <boxGeometry args={[0.05, 0.016, 0.008]} />
              <meshBasicMaterial color="#1E1B4B" />
            </mesh>
            {/* Lash Spikes */}
            <mesh position={[-0.035, 0.014, 0]} rotation={[0, 0, 0.25]}>
              <coneGeometry args={[0.008, 0.026, 8]} />
              <meshBasicMaterial color="#1E1B4B" />
            </mesh>
          </group>

          {/* Lower Eyelash Accent */}
          <mesh position={[0.01, -0.068, 0.003]}>
            <boxGeometry args={[0.065, 0.008, 0.005]} />
          ...
          <group position={[-0.005, -0.006, 0.002]}>
            ...
            {eyeStyle === 'cateye' && (
              <>
                ...
                <mesh position={[-0.024, -0.024, 0.004]}>
                  <circleGeometry args={[0.008, 12]} />
                  <meshBasicMaterial color="#FFFFFF" />
                </mesh>
              </>
      ...
      {/* 2. EYEBROWS                                                  */}
      {/* ============================================================ */}
      <group position={[0, 0.17, 0.385]}>
        {eyebrowStyle === 'gentle' && (
          <>
            <mesh position={[-0.13, 0, 0]} rotation={[0, -0.15, -0.08]}>
              <boxGeometry args={[0.09, 0.014, 0.01]} />
        ...
        {eyebrowStyle === 'straight' && (
          <>
            <mesh position={[-0.13, 0, 0]} rotation={[0, -0.15, 0]}>
        ...
        {eyebrowStyle === 'confident' && (
          <>
            <mesh position={[-0.13, 0.01, 0]} rotation={[0, -0.15, -0.22]}>
              <boxGeometry args={[0.095, 0.014, 0.01]} />
              <meshBasicMaterial color={colors.hairColor} />
            </mesh>
            <mesh position={[0.13, 0.01, 0]} rotation={[0, 0.15, 0.22]}>
        ...
        {eyebrowStyle === 'playful' && (
          <>
            <mesh position={[-0.13, 0.02, 0]} rotation={[0, -0.15, 0.12]}>
              <boxGeometry args={[0.09, 0.014, 0.01]} />
              <meshBasicMaterial color={colors.hairColor} />
            </mesh>
            <mesh position={[0.13, 0.01, 0]} rotation={[0, 0.15, 0.08]}>
              <boxGeometry args={[0.09, 0.014, 0.01]} />
              <meshBasicMaterial color={colors.hairColor} />
            </mesh>
          </>
      ...
      {/* 3. CUTE SOFT NOSE                                            */}
      {/* ============================================================ */}
      <group position={[0, -0.01, 0.395]}>
        <mesh>
          <sphereGeometry args={[0.015, 16, 16]} />
          <meshStandardMaterial color={colors.skinTone} roughness={0.35} />
        </mesh>
      </group>
      ...
      <group position={[0, -0.04, 0.38]}>
        {/* Left Cheek Blush */}
        <group position={[-0.17, 0, 0]} rotation={[0, -0.3, 0]}>
          <mesh>
